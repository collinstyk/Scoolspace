...
function Platforms() {
  return (
    <section className="smMobile:w-[90.2%] mx-auto my-40 flex w-[91%] flex-col gap-4 md:w-[704px] lg:w-[960px]">
      ...
      <div className="smMobile:w-[89.1%] smMobile:justify-between smMobile:gap-0 mx-auto flex flex-wrap justify-center gap-x-8 gap-y-4 text-pitch-black sm:w-[77.8%] lg:w-[548px]">
